...
**The Putting-Out System (Pre-Industrial Organization).** Before factories, manufacturing operated through the putting-out system, where merchants coordinated production across dispersed households, each working independently. It worked until scale demanded tighter coordination than the system could provide. SONAR's gap detection (identifying processes that are informal, tribal, or orphaned) echoes the recognition that coordination models have structural ceilings.
...
| Flow Classification | Lean waste categories | None | Four-type taxonomy calibrated for AI-era interventions |
...
| Time Friction | Lead Time / Cycle Time (Lean) | None | Applied to invisible knowledge-work queues |
| Touch Friction | Theory of Constraints (Goldratt) | None | Cumulative handoff drag, not single bottleneck |
| System Friction | Transaction Cost Economics (Coase) | None | Operationalized as tool-boundary crossing costs |
...
| Tiered Roadmap | Wardley Mapping evolution stages | None | Execution sequencing, not market positioning |
